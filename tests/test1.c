...
int main() {
    int array[10] = { 0, 0, 1, 1, 0, 0, 1, 0, 0, 1 };
    ...
    Combinator c8 = build("0 1", seq, NULL, zero_one_combinators);
    ...
    Combinator c7 = build("1 0", seq, NULL, one_zero_combinators);
    ...
    Combinator c6 = build("(1 0 | 0 1)", alt, NULL, c6_combinators);
    ...
    PUSH_DYNARRAY(c5_combinators, &one);
    Combinator c5 = build("1 1", seq, NULL, c5_combinators);
    ...
    PUSH_DYNARRAY(c4_combinators, &zero);
    Combinator c4 = build("0 0", seq, NULL, c4_combinators);
    ...
    Combinator c1 = build("(1 1 | 0 0)*", seq, NULL, c1_combinators);
